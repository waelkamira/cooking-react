...
//   const [isOpen, setIsOpen] = useState(false);
//   const session = useSession();
//   const [editedRecipe, setEditedRecipe] = useState(null); // Change initial state to null
//   const { id } = useParams();
//   const [inputs, setInputs] = useState({
//     image: '',
//     mealName: '',
...
//     const inputValue = e.target.value;
//     setUrl(inputValue);
//     handleGenerateEmbed(inputValue);
//   };
...
//       const youtubeEmbedLink = `https://www.youtube.com/embed/${videoId}`;
//       setEmbedLink(youtubeEmbedLink);
//       setInputs((prevInputs) => ({ ...prevInputs, link: youtubeEmbedLink }));
//     } else {
//       setEmbedLink('');
//     }
//   };
...
//             }
//             className="bg-red-500 mb-2 w-full sm:w-fit hover:bg-red-700 text-white hover:scale-105 border text-center select-none  rounded-lg p-2"
//           >
//             حذف الصورة
//           </button>
//           <h3
//             className="text-one text-xl sm:text-2xl md:text-3xl select-none my-4 sm:my-8 p-2 bg-four rounded-lg"
//             contentEditable="true"
//             onInput={(e) =>
//               setInputs((prevInputs) => ({
//                 ...prevInputs,
...
//             }
//           >
//             {inputs?.ingredients || editedRecipe?.ingredients}
//             {/* //? هذا السبان لابقاء الفوكس */}
//             <span
//               contentEditable="false"
//               className={
...
//             }
//           >
//             {inputs?.theWay || editedRecipe?.theWay}
//             {/* //? هذا السبان لابقاء الفوكس */}
//             <span
//               contentEditable="false"
//               className={
//                 inputs?.theWay && editedRecipe?.theWay ? 'hidden' : 'text-four'
//               }
//             >
//               &#13;&#10;
//             </span>
...
//             }
//           >
//             {inputs?.advise || editedRecipe?.advise}
//             {/* //? هذا السبان لابقاء الفوكس */}
//             <span
//               contentEditable="false"
//               className={
//                 inputs?.advise && editedRecipe?.advise ? 'hidden' : 'text-four'
//               }
//             >
//               &#13;&#10;
//             </span>
